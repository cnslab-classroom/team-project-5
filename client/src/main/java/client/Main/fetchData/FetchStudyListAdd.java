...
public class FetchStudyListAdd {
  ...
  public static void sendPostList(String study_group_name, String study_emoji) {
    try {
      // 서버 URL
      URL url = new URL("http://localhost:8080/group/1/list");
      ...
      String jsonInputString = String.format(
          "{ \"study_group_name\": \"%s\", \"study_emoji\": \"%s\" }",
          study_group_name, study_emoji);
      ...
      // 성공 메시지
      JOptionPane.showMessageDialog(null, "스터디 그룹이 추가되었습니다: " + study_group_name);
